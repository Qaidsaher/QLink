<header
    ...
    class="sticky top-0 z-20 flex-col justify-between hidden h-screen pr-2 md:flex border-slate-200 dark:border-slate-800 md:w-[88px] xl:w-[275px] transition-all duration-300 ">
    ...
    <div class="flex flex-col items-center flex-grow h-full p-1 overflow-y-auto xl:items-start">
        ...
        <div class="w-full p-1 my-2 bg-gray-100 rounded-full dark:bg-slate-900">
            <a href="{{ route('home') }}"
                ...
                <span class="hidden xl:inline" style="font-family: sans-serif;">Link</span>
            </a>
        </div>
